            ...
            <div className="glass-card p-6 overflow-x-auto">
                <div className="flex justify-between min-w-[800px] gap-4">
                    ...
                    <div
                        ...
                        <span className="text-lg font-bold">25°/14°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
                    ...
                    <div
                        ...
                        <span className="text-lg font-bold">22°/12°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
                    ...
                    <div
                        ...
                        <span className="text-lg font-bold">19°/11°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
                    ...
                    <div
                        ...
                        <span className="text-lg font-bold">18°/10°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
                    ...
                    <div
                        ...
                        <span className="text-lg font-bold">21°/12°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
                    ...
                    <div
                        ...
                        <span className="material-symbols-outlined text-on-surface-variant mb-2"><CiCloudOn /></span>
                        <span className="text-lg font-bold">26°/15°</span>
                        <div className="flex items-center gap-1 mt-1">
                            <span className="material-symbols-outlined text-[10px] text-blue-400"><IoIosWater /></span>
